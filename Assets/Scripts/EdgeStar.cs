...
// This class willl be for stars plaed on mesh edges

public class EdgeStar : StateMachine
{
    ...
    void Awake()
    {
        velocity = Random.Range(data.minVelocityEdge, data.maxVelocityEdge);
    ...
    protected override void Start()
    {
        ...
        size = Random.Range(data.minSizeEdge, data.maxSizeEdge);
    ...
    protected override void StateUpdateCallback()
    {
        ...
        tex.Twinkle(data.twinkleSpeedEdge);
