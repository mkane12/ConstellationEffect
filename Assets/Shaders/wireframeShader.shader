// Adopted from https://github.com/UnityCommunity/UnityLibrary/blob/master/Assets/Shaders/2D/Effects/WireFrame.shader
...
Shader "Custom/wireframeShader" {
	...
	SubShader {
	// adjust tags for transparency https://unitycoder.com/blog/2016/11/28/wireframe-shader/
		...
		Pass
		{
			...
			fixed4 frag (g2f i) : SV_Target
			{
				...
				return float4(_LineColor.r, _LineColor.g, _LineColor.b, _Transparency);
			}
			ENDCG
		}
